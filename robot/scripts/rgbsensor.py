from _future_ import print_function # use python 3 syntax but make it compatible with python 2
...
try:
    ...
    while True:
        ...
        # BP.PORT_3 specifies that we are looking for the value of sensor port 1.
